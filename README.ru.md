...
- [Генератор палитр](./docs/palette-generator.md) из одного базового цвета в OKLCH: оттенки, тональная шкала, градиент, шкала прозрачности, гармонии, семантический набор
